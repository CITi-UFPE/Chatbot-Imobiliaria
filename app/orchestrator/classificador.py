...
SYSTEM_PROMPT = (
    ...
    "onde/como pagar (chave Pix, dados bancários), se existe alguma conta, fatura ou "
    "cobrança em aberto ('quais são minhas contas em aberto?', 'quais são minhas faturas?', "
    "'quanto estou devendo?', inclusive com multa e juros de uma cobrança já atrasada — é "
    "consulta, não risco financeiro) e o status de pagamentos recentes (últimos 30 dias), "
    "perguntas HIPOTÉTICAS sobre "
